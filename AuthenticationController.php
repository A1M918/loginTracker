            ...
            try{
               $conn =  mysqli_connect($host,$user,$pass,$db);
                if(mysqli_connect_errno()){
                    ...
                    $sql1 = "SELECT user_name from Users where id = '".$_SESSION['authenticated_user_id']."'";
					...
					$id = '';
					$sqlID = "SELECT max(id) as id from cstm_logintracker";
                    ...
                    $sql2 = "INSERT INTO cstm_logintracker(id,name,loggedin,u_id) VALUES ($id,'".$userName."','".date("Y-m-d h:i:sa")."', '".$_SESSION['authenticated_user_id']."')";
